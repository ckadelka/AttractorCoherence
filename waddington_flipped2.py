...
lines = colored_line(x_L, 1-t_L, stability_gradient, ax, linewidth=6, cmap="Reds")
lines = colored_line(x_R, 1-t_R, stability_gradient, ax, linewidth=6, cmap="Reds")
...
ax.text(0.5,0.5,'very stable\nprogenitor cells',va='center',ha='center')
ax.text(0.5,1-0.98,'less stable\nmature cells',va='bottom',ha='center')
